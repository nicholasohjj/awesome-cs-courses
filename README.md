...
- [CMSC 430](https://www.cs.umd.edu/class/fall2025/cmsc430/) **Introduction to Compilers** *Univ of Maryland* 💻 📝
...
- [CS 164](https://berkeley-cs164-sp25.github.io/) **Hack your language!** *UC Berkeley* 🎥 💻 📝
...
- [CS 173](http://cs.brown.edu/courses/cs173/) **Programming Languages** *Brown University* 🎥 💻
...
- [CS2104](https://www.comp.nus.edu.sg/~cs2104/) **Programming Language Concepts** *National University of Singapore* 📝 💻 📚
	- This course introduces the concepts that serve as a basis for hundreds of programming languages. It aims to provide the students with a basic understanding and appreciation of the various essential programming-languages constructs, programming paradigms, evaluation criteria and language implementation issues. The course covers concepts from imperative, object-oriented, functional, logic, constraints, and concurrent programming. These concepts are illustrated by examples from varieties of languages such as Pascal, C, Java, Smalltalk, Scheme, Haskell, Prolog. The course also introduces various implementation issues, such as pseudo-code interpretation, static and dynamic semantics, abstract machine, type inferencing, etc.
- [CS 223](https://www.classes.cs.uchicago.edu/archive/) **Purely Functional Data Structures In Elm** *University of Chicago* 💻 📝
...
- [CS 240h](https://www.scs.stanford.edu/16wi-cs240h/) **Functional Systems in Haskell** *Stanford University* 💻 📝
	- Building software systems in Haskell
- [CS 421](https://courses.engr.illinois.edu/cs421/) **Programming Languages and Compilers** *Univ of Illinois, Urbana-Champaign* 🎥 💻 📝
 Course that uses OCaml to teach functional programming and programming language design.
- [CS 3110](https://www.cs.cornell.edu/courses/cs3110/2019fa/) **Data Structures and Functional Programming** *Cornell University* 💻 📝
...
- [CS 4120](http://www.cs.cornell.edu/courses/CS4120/) **Introduction to Compilers** *Cornell University* 💻 📝 📚
...
- [CS 5114](https://cornell-pl.github.io/cs6114/) **Network Programming Languages** *Cornell University* 📝 📚
...
- [PCPP](http://www.itu.dk/people/sestoft/itu/PCPP/E2016/) **Practical Concurrent and Parallel Programming** *IT University of Copenhagen* 📝 💻 📚
...
- [CS2040](https://www.comp.nus.edu.sg/~stevenha/cs2040.html) **Data Structures and Algorithms** *National University of Singapore* 💻 📝
...
- [CS2040S](https://www.comp.nus.edu.sg/~stevenha/cs2040s.html) **Data Structures and Algorithms** *National University of Singapore* 💻 📝
	- The Java-based variant of CS2040. This course introduces students to the design and implementation of fundamental data structures and algorithms. The course covers basic data structures (linked lists, stacks, queues, binary heaps, hash tables, trees, and graphs), searching and sorting algorithms, and basic analysis of algorithms. Uses Java programming language with basic object-oriented programming concepts.
...
- [CS 4820](https://www.cs.cornell.edu/courses/cs4820/2025fa/) **Introduction to Analysis of Algorithms** *Cornell University* 💻 📝 📚
...
- [CS1231S](https://www.comp.nus.edu.sg/~cs1231s/) **Discrete Structures** *National University of Singapore* 📝 💻 📚
...
- [CMU 462](http://15462.courses.cs.cmu.edu) **Computer Graphics** *Carnegie Mellon University* 📝 💻 📚
...
- [CS 4620](http://www.cs.cornell.edu/Courses/CS4620) **Introduction to Computer Graphics** *Cornell University* 💻 📝 📚
	- The study of creating, manipulating, and using visual images in the computer.
- [CS 4670](http://www.cs.cornell.edu/courses/CS4670/) **Introduction to Computer Vision** *Cornell University* 💻 📝 📚
	- This course will provide an introduction to computer vision, with topics including image formation, feature detection, motion estimation, image mosaics, 3D shape reconstruction, and object and face detection and recognition. Applications of these techniques include building 3D maps, creating virtual characters, organizing photo and video databases, human computer interaction, video surveillance, automatic vehicle navigation, and mobile computer vision. This is a project-based course, in which you will implement several computer vision algorithms throughout the semester.
...
- [CSCI 1230](https://cs1230.graphics/) **Introduction to Computer Graphics** *Brown University* 💻 📝
...
- [CSCI-GA.2270-001](https://cs.nyu.edu/~perlin/courses/fall2024/) **Graduate Computer Graphics** *New York University* 💻 📝 📚
...
- [CS 6640](http://www.cs.cornell.edu/courses/CS6640/2012fa/index.shtml#) **Computational Photography** *Cornell University* 💻 
	- A course on the emerging applications of computation in photography. Likely topics include digital photography, unconventional cameras and optics, light field cameras, image processing for photography, techniques for combining multiple images, advanced image editing algorithms, and projector-camera systems.
- [CS 6650](http://www.cs.cornell.edu/courses/CS6650/) **Computational Motion** *Cornell University* 📚
...
- [CS 3152](http://www.cs.cornell.edu/courses/CS3152/) **Introduction to Computer Game Development** *Cornell University* 💻 📝 📚
...
- [6.858](http://css.csail.mit.edu/6.858/) **Computer Systems Security** *MIT* 🎥 📝 💻 <img src="" width="20" height="20" alt="Readings" title="Readings" />
...
- [15-721](http://15721.courses.cs.cmu.edu/) **Database Systems** *Carnegie-Mellon University* 🎥 💻 📚
...
- [15-445/645](http://15445.courses.cs.cmu.edu/) **Database Systems** *Carnegie-Mellon University* 🎥 💻 📚
...
- [15-749](http://www.andrew.cmu.edu/course/15-749/) **Engineering Distributed Systems** *Carnegie-Mellon University* 📚	
 	- A project focused course on Distributed Systems with a fantastic list of readings
...
- [CS 168](https://sp25.cs168.io/) **Computer Networks** *UC Berkeley*💻 📚 📝
...
- [15-418](https://www.cs.cmu.edu/~418/) **Parallel Computer Architecture and Programming** *Carnegie-Mellon University* 🎥 💻 📝 📚
...
- [CS2103](https://www.comp.nus.edu.sg/~cs2103) **Software Engineering** *National University of Singapore* 📝 💻 📚
...
- [CS2113](https://www.comp.nus.edu.sg/~cs2113/) **Software Engineering & Object-Oriented Programming** *National University of Singapore* 📝 💻 📚
...
- [CS 5150](http://www.cs.cornell.edu/courses/CS5150) **Software Engineering** *Cornell University* 💻 📝 📚
